...
function isOtherSender(record) {
  return record.type === "user" && record.promptSource !== void 0 && !record.isMeta && !(Array.isArray(record.message?.content) && record.message.content.some((b) => blockType(b) === "tool_result"));
}

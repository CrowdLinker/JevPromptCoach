...
var CHECKS = [
  ...
  },
  {
    ...
    inlineEligible: true,
    conversation: {
      instructions: "What should be true once the request in the message is done is known: the message states the outcome or the output it wants, or it approves a proposal from the agent that describes the resulting behaviour.",
      criteria: {
        ...
        false: "Only names a step to carry out (commit, push, deploy, merge, review, run something) without an outcome, even when the conversation describes the work around it; or starts new work without an end state."
      },
      threshold: 0.2,
